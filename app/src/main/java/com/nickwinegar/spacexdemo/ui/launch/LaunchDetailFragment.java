...
import com.nickwinegar.spacexdemo.dummy.DummyContent;
...
public class LaunchDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.launch_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.launch_detail)).setText(mItem.details);
        }
